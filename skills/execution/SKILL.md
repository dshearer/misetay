...
1. **List tasks** - Use `dshearer.smidja/listTasks` to see what needs to be done
...
```
Use dshearer.smidja/listTasks to get all tasks
...
1. Check task list again with `dshearer.smidja/listTasks`
